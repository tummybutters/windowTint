...
REWRITE_PATHS = {
    ...
    "/tesla-model-y-window-tint": "/tesla-model-y-window-tint.html",
    "/tesla-model-3-window-tint": "/tesla-model-3-window-tint.html",
    "/tesla-cybertruck-window-tint": "/tesla-cybertruck-window-tint.html",
    "/mobile-window-tinting-near-me": "/mobile-window-tinting-near-me",
    "/mobile-ceramic-window-tint-near-me": "/mobile-ceramic-window-tint-near-me.html",
    "/windshield-ceramic-tint": "/windshield-ceramic-tint",
    "/ceramic-window-tint-pricing": "/ceramic-window-tint-pricing",
    "/nano-ceramic-window-tint": "/nano-ceramic-window-tint.html",
