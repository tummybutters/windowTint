...
const photoCards = () => `
                <figure class="paid-hero-strip__item"><img src="/assets/ceramic-coating/foam-sedan.webp" alt="Sedan covered in wash foam during vehicle preparation" width="1012" height="1800" fetchpriority="high"><figcaption><p>Preparation comes before paint protection.</p><span class="paid-hero-strip__reviewer">Obsidian process</span></figcaption></figure>
...
<body class="paid-page">
    ...
    <main>
        ...
        <section class="paid-hero-strip" aria-label="Vehicle care and finish examples"><div class="paid-hero-strip__grid">${photoCards()}
            </div></section>
        ...
        <section class="paid-band paid-band--ink"><div class="paid-shell"><div class="paid-section-heading"><span>Local exposure, better protected</span><h2>${data.exposureHeading}</h2><p>${data.exposureBody}</p></div><div class="paid-photo-grid"><figure class="paid-photo"><img src="/assets/ceramic-coating/foam-sedan.webp" alt="Sedan covered in wash foam during vehicle preparation" width="1012" height="1800" loading="lazy"><figcaption>Preparation before protection</figcaption></figure><figure class="paid-photo"><img src="/assets/ceramic-coating/paint-detail.webp" alt="Detailed view of a reflective paint finish" width="1012" height="1800" loading="lazy"><figcaption>Clarity built into the finish</figcaption></figure></div></div></section>
    ...
    <footer class="paid-footer"><div class="paid-shell paid-footer__inner"><a href="/ceramic-coating">Ceramic coating services &amp; preparation</a><span>Mobile ceramic coating in ${data.city}, California</span></div></footer>
