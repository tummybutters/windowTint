...
assert.match(page, /<h1>Mobile Ceramic Coating<br><span>in Orange County<\/span><\/h1>/);
assert.match(page, /href="\/ceramic-coating-cost-paint-correction#packages"/);
assert.match(page, /Packages from \$550/);
