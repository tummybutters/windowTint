...
async function sendAlert(lead,fetchImpl=fetch){
 ...
 const wants={'Front two windows':'Front two window tint','Sides + rear':'Side and rear window tint','Windshield / other':'Windshield tint or another tint request','Help me choose':'Help choosing which windows to tint'}[lead.coverage]||lead.coverage;
